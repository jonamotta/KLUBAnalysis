#!/bin/bash
export TAG="bins_50_47"
export CF="$CMSSW_BASE/src/KLUBAnalysis/combiner_binOptimization/DistribScanSteps/Quantile/bins_50_47/"
export LEPTONS="ETau"
export SELECTIONS="s2b0jresolvedMcut sboostedLLMcut"
...
do
		...
		rm comb.*
		combineCards.py -S hh_*_C2_L${NAMESAMPLE}${i}_13Te*.txt hh_*_C3_L${NAMESAMPLE}${i}_13Te*.txt >> comb.txt
