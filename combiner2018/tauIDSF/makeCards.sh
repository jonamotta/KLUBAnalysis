...
python combiner2018/tauIDSF/makeCards.py --tag $tag --ch $channel --decay bothDM0 --sel baselineHTauTau_bothDM0_DY
python combiner2018/tauIDSF/makeCards.py --tag $tag --ch $channel --decay bothDM1 --sel baselineHTauTau_bothDM1_DY
python combiner2018/tauIDSF/makeCards.py --tag $tag --ch $channel --decay bothDM10 --sel baselineHTauTau_bothDM10_DY
python combiner2018/tauIDSF/makeCards.py --tag $tag --ch $channel --decay bothDM11 --sel baselineHTauTau_bothDM11_DY
