...
void ratioPU (uint begin = 0, uint max=300000000,string const &infileName = "../../inputFiles/Legacy2018_backgrounds/3_TTToHadronic_TuneCP5_13TeV-powheg-pythia8__RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1.txt", string const &myFileName = "MyMCPileupHistogram_TT2018_06May2020")
{
