#!/bin/bash
export TAG="bins_50"
export CF="$CMSSW_BASE/src/KLUBAnalysis/combiner_binOptimization/NumbAndDistribScanSteps_ETau2016DNNoutSM_kl_1/FlatB/VBFloose/bins_50/"
export LEPTONS="ETau"
export SELECTIONS="VBFlooseMcut"
export YEAR="2016"
