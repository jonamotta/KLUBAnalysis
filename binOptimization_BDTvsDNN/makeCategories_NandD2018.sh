#!/bin/bash
export TAG="bins_10"
export CF="$CMSSW_BASE/src/KLUBAnalysis/combiner_binOptimization/NumbAndDistribScanSteps_TauTau2018DNNoutSM_kl_1/FlatB/2b0j/bins_10/"
export LEPTONS="TauTau"
export SELECTIONS="s2b0jresolvedMcut"
export YEAR="2018"
...
do
		...
		do
				...
				python chcardMaker.py -f ${CF}/analyzedOutPlotter_${TAG}.root -o "_${TAG}" -c ${c} -y -s ${BASE} ${RESONANT} -u 1 -t -p ${CF} --year ${YEAR} --var ${VAR}
		done
done
echo " "
...
do
		...
		do
				...
				do
						...
						ln -ns /home/llr/cms/motta/CMSSW_10_2_16/src/KLUBAnalysis/combiner_binOptimization/prepareHybrid.py . # the f option forces to overwrite the link if it already exists (dangerous)
