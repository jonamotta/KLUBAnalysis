...
if variable == "BDToutSM_kl_1":
    ...
    #----
    df_opt_distribs2018['TauTau']['s2b0jresolvedMcut'] = "FlatB"
    ...
    df_opt_nBins2018['MuTau']['s1b1jresolvedMcut'] = 29
    df_opt_nBins2018['MuTau']['VBFlooseMcut'] = 14
    df_opt_nBins2018['MuTau']['VBFtightMcut'] = "---"
    #----
    df_opt_nBins2018['TauTau']['s2b0jresolvedMcut'] = 50
    ...
    df_opt_distribs2016['ETau']['s2b0jresolvedMcut'] = "FlatS"
    df_opt_distribs2016['ETau']['sboostedLLMcut'] = "FlatB"
    df_opt_distribs2016['ETau']['s1b1jresolvedMcut'] = "FlatS"
    df_opt_distribs2016['ETau']['VBFlooseMcut'] = "FlatSB"
    #----
    ...
    #----
    df_opt_distribs2016['TauTau']['s2b0jresolvedMcut'] = "FlatB"
    ...
    df_opt_nBins2016['ETau']['s2b0jresolvedMcut'] = 15
    df_opt_nBins2016['ETau']['sboostedLLMcut'] = 12
    df_opt_nBins2016['ETau']['s1b1jresolvedMcut'] = 27
    df_opt_nBins2016['ETau']['VBFlooseMcut'] = 50
    #----
    df_opt_nBins2016['MuTau']['s2b0jresolvedMcut'] = 18
    df_opt_nBins2016['MuTau']['sboostedLLMcut'] = 17
    df_opt_nBins2016['MuTau']['s1b1jresolvedMcut'] = 26
    df_opt_nBins2016['MuTau']['VBFlooseMcut'] = 12
    #----
    df_opt_nBins2016['TauTau']['s2b0jresolvedMcut'] = 42
    df_opt_nBins2016['TauTau']['sboostedLLMcut'] = 11
    df_opt_nBins2016['TauTau']['s1b1jresolvedMcut'] = 36
    df_opt_nBins2016['TauTau']['VBFlooseMcut'] = 30
...
if variable == "DNNoutSM_kl_1":
    ...
    # 2016 distributions
    df_opt_distribs2016 = pd.DataFrame(index=selections, columns=channels)
    df_opt_distribs2016['ETau']['s2b0jresolvedMcut'] = "FlatSB"
    df_opt_distribs2016['ETau']['sboostedLLMcut'] = "FlatB"
    df_opt_distribs2016['ETau']['s1b1jresolvedMcut'] = "FlatS"
    df_opt_distribs2016['ETau']['VBFlooseMcut'] = "FlatSB"
    #----
    df_opt_distribs2016['MuTau']['s2b0jresolvedMcut'] = "FlatSB"
    df_opt_distribs2016['MuTau']['sboostedLLMcut'] = "FlatB"
    df_opt_distribs2016['MuTau']['s1b1jresolvedMcut'] = "FlatS"
    df_opt_distribs2016['MuTau']['VBFlooseMcut'] = "FlatSB"
    #----
    df_opt_distribs2016['TauTau']['s2b0jresolvedMcut'] = "ConstSize"
    df_opt_distribs2016['TauTau']['sboostedLLMcut'] = "ConstSize"
    df_opt_distribs2016['TauTau']['s1b1jresolvedMcut'] = "FlatS"
    df_opt_distribs2016['TauTau']['VBFlooseMcut'] = "FlatB"
    # 2016 number of bins
    df_opt_nBins2016 = pd.DataFrame(index=selections, columns=channels)
    df_opt_nBins2016['ETau']['s2b0jresolvedMcut'] = 49
    df_opt_nBins2016['ETau']['sboostedLLMcut'] = 12
    df_opt_nBins2016['ETau']['s1b1jresolvedMcut'] = 12
    df_opt_nBins2016['ETau']['VBFlooseMcut'] = 22
    #----
    df_opt_nBins2016['MuTau']['s2b0jresolvedMcut'] = 49
    df_opt_nBins2016['MuTau']['sboostedLLMcut'] = 9
    df_opt_nBins2016['MuTau']['s1b1jresolvedMcut'] = 10
    df_opt_nBins2016['MuTau']['VBFlooseMcut'] = 28
    #----
    df_opt_nBins2016['TauTau']['s2b0jresolvedMcut'] = 36
    df_opt_nBins2016['TauTau']['sboostedLLMcut'] = 10
    df_opt_nBins2016['TauTau']['s1b1jresolvedMcut'] = 11
    df_opt_nBins2016['TauTau']['VBFlooseMcut'] = 36
